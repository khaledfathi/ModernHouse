        ...
        <form class="d-grid" action="{{ url('projectupdate') }}" method="get">
            ...
            <div class="messages">
                ...
                <div>
                    ...
                    <input type="text" name="id" value="{{ $project ? $project->id : null }}">
                </div>
                <div>
                    <label for="">رقم العميل</label>
                    <input type="text" name="customer_id" value="{{ $customer ? $customer->id : null }}">
                </div>
                <div>
                    <label for="">اسم العميل</label>
                    <input type="text" name="customer_name" value="{{ $customer ? $customer->name : null }}">
                </div>
                <div>
                    <label for="">تليفون العميل</label>
                    <input type="text" name="customer_phone" value="{{ $customer ? $customer->phone : null }}">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="amount" name="amount" value="{{ $project ? $project->amount : null }}">
                    <label for="">المبلغ المستحق</label>
                    <input type="text" id="remaining" name="remaining" id=""
                ...
                <div>
                    ...
                    <button id="deleteButton" type="button">حذف</button>
                        ...
                        <tbody>
                            @foreach ($transactions as $transaction)
                                <tr>
                                    ...
                                    <td><a href="{{ url('payment/' . $transaction->id.'?project_id='.$project->id.'&customer_id='.$customer->id) }}"><img
